...
(function() {
  function VietKhanhProtect() {
    ...
    if (VietKhanh === null) {
      ...
      window.location.replace("//facebook.com/pphanvankha.dev");
      return;
...
// ABOUT ME
document.getElementById("VietKhanhAbout_1").innerHTML = 'Phan Van Kha is a free source code sharing blog with quality and diverse content, we want to become a trusted destination for the programming community.';
// FOOTER
...
aElement.href = "//facebook.com/pphanvankha.dev";
const uElement = document.createElement("u");
uElement.style.color = "aliceblue";
uElement.textContent = "Phan Van Kha ♡";
...
// USER NAME + TÍCH XANH
document.getElementById("userName").innerHTML = 'Phan Văn Kha <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Twitter_Verified_Badge.svg/512px-Twitter_Verified_Badge.svg.png" width="17" height="17" alt="Tích Xanh">';
// CHECK FPS
...
let typed = new Typed(".GioiThieu", {
  strings: ["Hi my name is Phan Van Kha","Hey brother, I'm a Developer.", "I like website design =]]"],
  typeSpeed: 95,
  backSpeed: 75,
  loop: true
})
...
function Youtube() {
  setTimeout(function() {
    window.open('https://www.youtube.com/@phanvankha.developer', '_blank')},
  100);
}
function Facebook() {
  setTimeout(function() {
    window.open('https://www.facebook.com/pphanvankha.dev', '_blank')},
  100);
}
function Discord() {
  setTimeout(function() {
...
function Instagram() {
  setTimeout(function() {
    window.open('https://instagram.com/phanvankha.info/', '_blank')},
  100);
}
...
toastDiv.id = 'Toast';
toastDiv.textContent = '𝘿𝙚𝙨𝙞𝙜𝙣 𝙗𝙮 Phan Van Kha';
